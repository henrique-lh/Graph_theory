...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.composto_1.adicionaAresta('a1', 'O5', 'C2')
        ...
        self.social_media = MeuGrafo([
            'LOGAN', 'VITTOR', 'DH', 'CAIO', 'MATHEUS', 'JV', 'VINI', 'YAN', 'JAMYLE', 'CICERO', 'REBECA', 'LUANA', 'LUCAS', 'ANA', 
            'ELYZA', 'RADIJA', 'RAISSA', 'VANESSA', 'INGRID', 'LUIS', 'DUDA', 'ITALLO', 'LUIZA', 'MARQUES', 'JOAO', 'YURI', 'KAUE', 
    ...
    def test_ha_ciclo(self):
        self.assertEqual(self.g_p.ha_ciclo(), ['C', 'a7', 'T', 'a8', 'M', 'a6', 'C'])
        self.assertEqual(self.m1.ha_ciclo(), ['A', '2', 'G', '9', 'H', '10', 'F', '11', 'B', '1', 'A'])
        self.assertEqual(self.abc.ha_ciclo(), ['A', 'a3', 'C', 'a2', 'B', 'a1', 'A'])
        self.assertEqual(self.m2.ha_ciclo(), ['2', 'a7', '5', 'a8', '6', 'a6', '2'])
        self.assertEqual(self.composto_1.ha_ciclo(), ['C9', 'a14', 'C11', 'a15', 'C12', 'a17', 'C14', 'a13', 'C13', 'a26', 'C10', 'a11', 'C9'])
        self.assertEqual(self.composto_2.ha_ciclo(), False)
