...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_p.adicionaAresta('a5', 'P', 'C', 3)
        self.g_p.adicionaAresta('a6', 'M', 'C', 5)
        self.g_p.adicionaAresta('a7', 'T', 'C', 2)
        self.g_p.adicionaAresta('a8', 'M', 'T', 3)
        self.g_p.adicionaAresta('a9', 'T', 'Z', 1)
        ...
        self.weird_graph.adicionaAresta("a", "J", "C", 2)
        self.weird_graph.adicionaAresta("b", "J", "E", 2)
        self.weird_graph.adicionaAresta("c", "J", "J", 1)
        self.weird_graph.adicionaAresta("d", "C", "P", 2)
        self.weird_graph.adicionaAresta("e", "C", "C", 1)
        self.weird_graph.adicionaAresta("f", "E", "M", 2)
        self.weird_graph.adicionaAresta("g", "E", "E", 1)
        self.weird_graph.adicionaAresta("h", "P", "M", 2)
        self.weird_graph.adicionaAresta("i", "P", "P", 1)
        self.weird_graph.adicionaAresta("j", "M", "M", 1)
        ...
        self.spire_graph.adicionaAresta('a', '0', '0', 1)
        self.spire_graph.adicionaAresta('b', '0', '2', 3)
        self.spire_graph.adicionaAresta('c', '2', '6', 2)
        self.spire_graph.adicionaAresta('d', '0', '6', 6)
        self.spire_graph.adicionaAresta('e', '6', '2', 1)
        self.spire_graph.adicionaAresta('f', '6', '4', 4)
        ...
        self.m1.adicionaAresta("1", "A", "B", 3)
        self.m1.adicionaAresta("2", "A", "G", 2)
        self.m1.adicionaAresta("3", "A", "J", 1)
        self.m1.adicionaAresta("4", "K", "G", 1)
        self.m1.adicionaAresta("5", "K", "J", 2)
        self.m1.adicionaAresta("6", "J", "G", 3)
        self.m1.adicionaAresta("7", "J", "I", 1)
        self.m1.adicionaAresta("8", "I", "G", 1)
        self.m1.adicionaAresta("9", "G", "H", 2)
        self.m1.adicionaAresta("10", "H", "F", 3)
        self.m1.adicionaAresta("11", "F", "B", 6)
        self.m1.adicionaAresta("12", "B", "G", 1)
        self.m1.adicionaAresta("13", "B", "C", 3)
        self.m1.adicionaAresta("14", "C", "D", 2)
        self.m1.adicionaAresta("15", "D", "E", 2)
        self.m1.adicionaAresta("16", "D", "B", 5)
        self.m1.adicionaAresta("17", "E", "B", 4)

        self.m2 = MeuGrafo(["1", "2", "3", "4", "5", "6", "7", "8", "9"])
        self.m2.adicionaAresta("a1", "1", "2", 1)
        self.m2.adicionaAresta("a3", "2", "3", 1)
        self.m2.adicionaAresta("a4", "2", "3", 2)
        self.m2.adicionaAresta("a2", "2", "4", 2)
        self.m2.adicionaAresta("a5", "2", "4", 3)
        self.m2.adicionaAresta("a6", "2", "6", 1)
        self.m2.adicionaAresta("a7", "2", "5", 2)
        self.m2.adicionaAresta("a8", "5", "6", 3)
        self.m2.adicionaAresta("a9", "6", "8", 2)
        self.m2.adicionaAresta("a10", "6", "7", 1)
        self.m2.adicionaAresta("a11", "7", "8", 1)
        self.m2.adicionaAresta("a12", "8", "9", 1)
        ...
        self.composto_1 = MeuGrafo([
            ...
            'O1', 'O2', 'O3', 'O4', 'O5',
            'N1', 'N2'])
        self.composto_1.adicionaAresta('a0', 'H2', 'C1', 1)
        self.composto_1.adicionaAresta('a1', 'C2', 'O5', 2)
        self.composto_1.adicionaAresta('a2', 'C2', 'O5', 3)
        self.composto_1.adicionaAresta('a3', 'H5', 'C7', 1)
        self.composto_1.adicionaAresta('a4', 'H7', 'C11', 4)
        self.composto_1.adicionaAresta('a5', 'C12', 'H15', 3)
        self.composto_1.adicionaAresta('a6', 'C1', 'H3', 1)
        self.composto_1.adicionaAresta('a7', 'C3', 'N1', 2)
        self.composto_1.adicionaAresta('a8', 'C10', 'H8', 1)
        self.composto_1.adicionaAresta('a9', 'C13', 'H12', 3)
        self.composto_1.adicionaAresta('a10', 'C7', 'C3', 1)
        self.composto_1.adicionaAresta('a11', 'C9', 'C10', 2)
        self.composto_1.adicionaAresta('a12', 'C10', 'C9', 3)
        self.composto_1.adicionaAresta('a13', 'C14', 'C13', 2)
        self.composto_1.adicionaAresta('a14', 'C11', 'C9', 3)
        self.composto_1.adicionaAresta('a15', 'C11', 'C12', 1)
        self.composto_1.adicionaAresta('a16', 'C11', 'C12', 2)
        self.composto_1.adicionaAresta('a17', 'C12', 'C14', 3)
        self.composto_1.adicionaAresta('a18', 'C14', 'C13', 1)
        self.composto_1.adicionaAresta('a19', 'C7', 'C9', 7)
        self.composto_1.adicionaAresta('a20', 'C3', 'H6', 2)
        self.composto_1.adicionaAresta('a21', 'C2', 'C3', 1)
        self.composto_1.adicionaAresta('a22', 'O1', 'C2', 2)
        self.composto_1.adicionaAresta('a23', 'N1', 'C8', 3)
        self.composto_1.adicionaAresta('a24', 'C1', 'O1', 1)
        self.composto_1.adicionaAresta('a25', 'C14', 'H16', 1)
        self.composto_1.adicionaAresta('a26', 'C10', 'C13', 1)
        self.composto_1.adicionaAresta('a27', 'C8', 'C6', 2)
        self.composto_1.adicionaAresta('a28', 'C8', 'O2', 3)
        self.composto_1.adicionaAresta('a29', 'C6', 'C5', 4)
        self.composto_1.adicionaAresta('a30', 'N2', 'H11', 1)
        self.composto_1.adicionaAresta('a31', 'C5', 'C4', 2)
        self.composto_1.adicionaAresta('a32', 'C8', 'O2', 2)
        self.composto_1.adicionaAresta('a33', 'C6', 'H10', 3)
        self.composto_1.adicionaAresta('a34', 'H14', 'C5', 1)
        self.composto_1.adicionaAresta('a35', 'C4', 'O3', 3)
        self.composto_1.adicionaAresta('a36', 'C6', 'N2', 3)
        self.composto_1.adicionaAresta('a37', 'C5', 'H17', 1)
        self.composto_1.adicionaAresta('a38', 'C4', 'O4', 3)
        self.composto_1.adicionaAresta('a39', 'O4', 'H13', 3)
        self.composto_1.adicionaAresta('a40', 'C4', 'O3', 4)
        self.composto_1.adicionaAresta('a41', 'C7', 'H4', 1)
        self.composto_1.adicionaAresta('a42', 'C1', 'H1', 1)
        self.composto_1.adicionaAresta('a43', 'H9', 'N2', 2)
        ...
        self.social_media.adicionaAresta('a1', 'JOSE', 'KAUA', 2)
        self.social_media.adicionaAresta('a2', 'KAUA', 'NANI', 3)
        self.social_media.adicionaAresta('a3', 'JOSE', 'KAUE', 4)
        self.social_media.adicionaAresta('a4', 'KAUE', 'KAUA', 2)
        self.social_media.adicionaAresta('a5', 'KAUE', 'NANI', 1)
        self.social_media.adicionaAresta('a6', 'GIO', 'RIAN', 4)
        self.social_media.adicionaAresta('a7', 'ANTHONY', 'JULIO', 3)
        self.social_media.adicionaAresta('a8', 'ITALLO', 'KAUE', 3)
        self.social_media.adicionaAresta('a9', 'KAUE', 'PEDRO', 4)
        self.social_media.adicionaAresta('a10', 'LUIZA', 'GIO', 3)
        self.social_media.adicionaAresta('a11', 'MARQUES', 'GIO', 2)
        self.social_media.adicionaAresta('a12', 'JOAO', 'ANTHONY', 1)
        self.social_media.adicionaAresta('a13', 'YURI', 'ANTHONY', 1)
        self.social_media.adicionaAresta('a14', 'ITALLO', 'LUIZA', 2)
        self.social_media.adicionaAresta('a15', 'LUIZA', 'MARQUES', 4)
        self.social_media.adicionaAresta('a16', 'MARQUES', 'JOAO', 1)
        self.social_media.adicionaAresta('a17', 'JOAO', 'YURI', 1)
        self.social_media.adicionaAresta('a18', 'DUDA', 'INGRID', 2)
        self.social_media.adicionaAresta('a19', 'ITALLO', 'LUIS', 2)
        self.social_media.adicionaAresta('a20', 'LUIS', 'LUIZA', 1)
        self.social_media.adicionaAresta('a21', 'VANESSA', 'INGRID', 3)
        self.social_media.adicionaAresta('a22', 'INGRID', 'LUIS', 1)
        self.social_media.adicionaAresta('a23', 'RAISSA', 'INGRID', 3)
        self.social_media.adicionaAresta('a24', 'LUCAS', 'LUIS', 3)
        self.social_media.adicionaAresta('a25', 'ANA', 'LUIS', 4)
        self.social_media.adicionaAresta('a26', 'LUANA', 'LUCAS', 1)
        self.social_media.adicionaAresta('a27', 'ANA', 'ELYZA', 2)
        self.social_media.adicionaAresta('a28', 'ELYZA', 'RADIJA', 2)
        self.social_media.adicionaAresta('a29', 'CICERO', 'RADIJA', 4)
        self.social_media.adicionaAresta('a30', 'JV', 'LUCAS', 3)
        self.social_media.adicionaAresta('a31', 'VINI', 'LUCAS', 3)
        self.social_media.adicionaAresta('a32', 'ANA', 'JAMYLE', 3)
        self.social_media.adicionaAresta('a33', 'JV', 'VINI', 2)
        self.social_media.adicionaAresta('a34', 'YAN', 'JAMYLE', 4)
        self.social_media.adicionaAresta('a35', 'JAMYLE', 'CICERO', 2)
        self.social_media.adicionaAresta('a36', 'CICERO', 'REBECA', 1)
        self.social_media.adicionaAresta('a37', 'DH', 'VINI', 1)
        self.social_media.adicionaAresta('a38', 'VITTOR', 'YAN', 3)
        self.social_media.adicionaAresta('a39', 'YAN', 'CAIO', 3)
        self.social_media.adicionaAresta('a40', 'CAIO', 'JAMYLE', 3)
        self.social_media.adicionaAresta('a41', 'REBECA', 'MATHEUS', 1)
        self.social_media.adicionaAresta('a42', 'VITTOR', 'LOGAN', 1)
        ...
        # Resultado da Minimum Spanning Tree
        self.g_p_mst = MeuGrafo(['C', 'E', 'T', 'Z', 'J', 'P', 'M'])
        self.g_p_mst.adicionaAresta('a2', 'C', 'E', 1)
        self.g_p_mst.adicionaAresta('a9', 'T', 'Z', 1)
        self.g_p_mst.adicionaAresta('a1', 'J', 'C', 2)
        self.g_p_mst.adicionaAresta('a4', 'P', 'C', 2)
        self.g_p_mst.adicionaAresta('a7', 'T', 'C', 2)
        self.g_p_mst.adicionaAresta('a8', 'M', 'T', 3)    

        self.grafo_dir_10_mst = MeuGrafo(['F', 'K', 'L', 'P', 'A', 'H', 'O', 'S', 'N', 'T', 'U', 'C', 'Q', 'Y', 'X', 'AA', 'AB', 'AF', 'AE', 'V', 'I', 'B', 'J', 'E', 'AC', 'Z', 'G', 'M', 'W', 'AD', 'AG', 'D', 'R'])
        self.grafo_dir_10_mst.adicionaAresta('14', 'F', 'K', 1)
        self.grafo_dir_10_mst.adicionaAresta('19', 'L', 'P', 1)
        self.grafo_dir_10_mst.adicionaAresta('2', 'A', 'H', 1)
        self.grafo_dir_10_mst.adicionaAresta('23', 'O', 'S', 1)
        self.grafo_dir_10_mst.adicionaAresta('25', 'N', 'T', 1)
        self.grafo_dir_10_mst.adicionaAresta('27', 'U', 'S', 1)
        self.grafo_dir_10_mst.adicionaAresta('29', 'S', 'T', 1)
        self.grafo_dir_10_mst.adicionaAresta('3', 'A', 'C', 1)
        self.grafo_dir_10_mst.adicionaAresta('32', 'Q', 'Y', 1)
        self.grafo_dir_10_mst.adicionaAresta('35', 'X', 'AA', 1)
        self.grafo_dir_10_mst.adicionaAresta('36', 'X', 'AB', 1)
        self.grafo_dir_10_mst.adicionaAresta('37', 'X', 'U', 1)
        self.grafo_dir_10_mst.adicionaAresta('42', 'AF', 'AE', 1)
        self.grafo_dir_10_mst.adicionaAresta('45', 'AE', 'V', 1)
        self.grafo_dir_10_mst.adicionaAresta('6', 'H', 'F', 1)
        self.grafo_dir_10_mst.adicionaAresta('9', 'I', 'B', 1)
        self.grafo_dir_10_mst.adicionaAresta('10', 'I', 'J', 2)
        self.grafo_dir_10_mst.adicionaAresta('13', 'F', 'J', 2)
        self.grafo_dir_10_mst.adicionaAresta('16', 'J', 'E', 2)
        self.grafo_dir_10_mst.adicionaAresta('38', 'AC', 'U', 2)
        self.grafo_dir_10_mst.adicionaAresta('41', 'Z', 'AF', 2)
        self.grafo_dir_10_mst.adicionaAresta('7', 'C', 'G', 2)
        self.grafo_dir_10_mst.adicionaAresta('11', 'G', 'L', 3)
        self.grafo_dir_10_mst.adicionaAresta('18', 'K', 'O', 3)
        self.grafo_dir_10_mst.adicionaAresta('20', 'M', 'Q', 3)
        self.grafo_dir_10_mst.adicionaAresta('40', 'W', 'AD', 3)
        self.grafo_dir_10_mst.adicionaAresta('44', 'AE', 'AG', 3)
        self.grafo_dir_10_mst.adicionaAresta('15', 'E', 'M', 4)
        self.grafo_dir_10_mst.adicionaAresta('4', 'B', 'D', 4)
        self.grafo_dir_10_mst.adicionaAresta('24', 'P', 'R', 5)
        self.grafo_dir_10_mst.adicionaAresta('43', 'AC', 'AE', 5)
        self.grafo_dir_10_mst.adicionaAresta('28', 'S', 'W', 7)

        self.weird_graph_mst = MeuGrafo(['J', 'C', 'E', 'P', 'M'])
        self.weird_graph_mst.adicionaAresta('a', 'J', 'C', 2)
        self.weird_graph_mst.adicionaAresta('b', 'J', 'E', 2)
        self.weird_graph_mst.adicionaAresta('d', 'C', 'P', 2)
        self.weird_graph_mst.adicionaAresta('f', 'E', 'M', 2)

        self.spire_graph_mst = MeuGrafo(['6', '2', '0', '4'])
        self.spire_graph_mst.adicionaAresta('e', '6', '2', 1)
        self.spire_graph_mst.adicionaAresta('b', '0', '2', 3)
        self.spire_graph_mst.adicionaAresta('f', '6', '4', 4)

        self.m1_mst = MeuGrafo(['B', 'G', 'A', 'J', 'K', 'I', 'C', 'D', 'E', 'H', 'F'])
        self.m1_mst.adicionaAresta('12', 'B', 'G', 1)
        self.m1_mst.adicionaAresta('3', 'A', 'J', 1)
        self.m1_mst.adicionaAresta('4', 'K', 'G', 1)
        self.m1_mst.adicionaAresta('7', 'J', 'I', 1)
        self.m1_mst.adicionaAresta('8', 'I', 'G', 1)
        self.m1_mst.adicionaAresta('14', 'C', 'D', 2)
        self.m1_mst.adicionaAresta('15', 'D', 'E', 2)
        self.m1_mst.adicionaAresta('9', 'G', 'H', 2)
        self.m1_mst.adicionaAresta('10', 'H', 'F', 3)
        self.m1_mst.adicionaAresta('13', 'B', 'C', 3)

        self.social_media_mst = MeuGrafo(['JOAO', 'ANTHONY', 'YURI', 'MARQUES', 'LUIS', 'LUIZA', 'INGRID', 'LUANA', 'LUCAS', 'CICERO', 'REBECA', 'DH', 'VINI', 'MATHEUS', 'VITTOR', 'LOGAN', 'KAUE', 'NANI', 'JOSE', 'KAUA', 'GIO', 'ITALLO', 'DUDA', 'ANA', 'ELYZA', 'RADIJA', 'JV', 'JAMYLE', 'VANESSA', 'RAISSA', 'YAN', 'CAIO', 'JULIO', 'RIAN', 'PEDRO'])
        self.social_media_mst.adicionaAresta('a12', 'JOAO', 'ANTHONY', 1)
        self.social_media_mst.adicionaAresta('a13', 'YURI', 'ANTHONY', 1)
        self.social_media_mst.adicionaAresta('a16', 'MARQUES', 'JOAO', 1)
        self.social_media_mst.adicionaAresta('a20', 'LUIS', 'LUIZA', 1)
        self.social_media_mst.adicionaAresta('a22', 'INGRID', 'LUIS', 1)
        self.social_media_mst.adicionaAresta('a26', 'LUANA', 'LUCAS', 1)
        self.social_media_mst.adicionaAresta('a36', 'CICERO', 'REBECA', 1)
        self.social_media_mst.adicionaAresta('a37', 'DH', 'VINI', 1)
        self.social_media_mst.adicionaAresta('a41', 'REBECA', 'MATHEUS', 1)
        self.social_media_mst.adicionaAresta('a42', 'VITTOR', 'LOGAN', 1)
        self.social_media_mst.adicionaAresta('a5', 'KAUE', 'NANI', 1)
        self.social_media_mst.adicionaAresta('a1', 'JOSE', 'KAUA', 2)
        self.social_media_mst.adicionaAresta('a11', 'MARQUES', 'GIO', 2)
        self.social_media_mst.adicionaAresta('a14', 'ITALLO', 'LUIZA', 2)
        self.social_media_mst.adicionaAresta('a18', 'DUDA', 'INGRID', 2)
        self.social_media_mst.adicionaAresta('a27', 'ANA', 'ELYZA', 2)
        self.social_media_mst.adicionaAresta('a28', 'ELYZA', 'RADIJA', 2)
        self.social_media_mst.adicionaAresta('a33', 'JV', 'VINI', 2)
        self.social_media_mst.adicionaAresta('a35', 'JAMYLE', 'CICERO', 2)
        self.social_media_mst.adicionaAresta('a4', 'KAUE', 'KAUA', 2)
        self.social_media_mst.adicionaAresta('a10', 'LUIZA', 'GIO', 3)
        self.social_media_mst.adicionaAresta('a21', 'VANESSA', 'INGRID', 3)
        self.social_media_mst.adicionaAresta('a23', 'RAISSA', 'INGRID', 3)
        self.social_media_mst.adicionaAresta('a24', 'LUCAS', 'LUIS', 3)
        self.social_media_mst.adicionaAresta('a30', 'JV', 'LUCAS', 3)
        self.social_media_mst.adicionaAresta('a32', 'ANA', 'JAMYLE', 3)
        self.social_media_mst.adicionaAresta('a38', 'VITTOR', 'YAN', 3)
        self.social_media_mst.adicionaAresta('a39', 'YAN', 'CAIO', 3)
        self.social_media_mst.adicionaAresta('a40', 'CAIO', 'JAMYLE', 3)
        self.social_media_mst.adicionaAresta('a7', 'ANTHONY', 'JULIO', 3)
        self.social_media_mst.adicionaAresta('a8', 'ITALLO', 'KAUE', 3)
        self.social_media_mst.adicionaAresta('a25', 'ANA', 'LUIS', 4)
        self.social_media_mst.adicionaAresta('a6', 'GIO', 'RIAN', 4)
        self.social_media_mst.adicionaAresta('a9', 'KAUE', 'PEDRO', 4)

        self.m2_mst = MeuGrafo(['1', '2', '6', '7', '8', '9', '3', '4', '5'])
        self.m2_mst.adicionaAresta('a1', '1', '2', 1)
        self.m2_mst.adicionaAresta('a10', '6', '7', 1)
        self.m2_mst.adicionaAresta('a11', '7', '8', 1)
        self.m2_mst.adicionaAresta('a12', '8', '9', 1)
        self.m2_mst.adicionaAresta('a3', '2', '3', 1)
        self.m2_mst.adicionaAresta('a6', '2', '6', 1)
        self.m2_mst.adicionaAresta('a2', '2', '4', 2)
        self.m2_mst.adicionaAresta('a7', '2', '5', 2)

        self.composto_1_mst = MeuGrafo(['H2', 'C1', 'C7', 'C3', 'C11', 'C12', 'C14', 'C13', 'C2', 'O1', 
        'H16', 'C10', 'H5', 'N2', 'H11', 'H14', 'C5', 'H17', 'H4', 'H1', 'H3', 'H8', 'O5', 'C9', 'H6', 
        'C8', 'C6', 'C4', 'O2', 'H9', 'N1', 'H10', 'O3', 'O4', 'H13', 'H15', 'H12', 'H7'])
        self.composto_1_mst.adicionaAresta('a0', 'H2', 'C1', 1)
        self.composto_1_mst.adicionaAresta('a10', 'C7', 'C3', 1)
        self.composto_1_mst.adicionaAresta('a15', 'C11', 'C12', 1)
        self.composto_1_mst.adicionaAresta('a18', 'C14', 'C13', 1)
        self.composto_1_mst.adicionaAresta('a21', 'C2', 'C3', 1)
        self.composto_1_mst.adicionaAresta('a24', 'C1', 'O1', 1)
        self.composto_1_mst.adicionaAresta('a25', 'C14', 'H16', 1)
        self.composto_1_mst.adicionaAresta('a26', 'C10', 'C13', 1)
        self.composto_1_mst.adicionaAresta('a3', 'H5', 'C7', 1)
        self.composto_1_mst.adicionaAresta('a30', 'N2', 'H11', 1)
        self.composto_1_mst.adicionaAresta('a34', 'H14', 'C5', 1)
        self.composto_1_mst.adicionaAresta('a37', 'C5', 'H17', 1)
        self.composto_1_mst.adicionaAresta('a41', 'C7', 'H4', 1)
        self.composto_1_mst.adicionaAresta('a42', 'C1', 'H1', 1)
        self.composto_1_mst.adicionaAresta('a6', 'C1', 'H3', 1)
        self.composto_1_mst.adicionaAresta('a8', 'C10', 'H8', 1)
        self.composto_1_mst.adicionaAresta('a1', 'C2', 'O5', 2)
        self.composto_1_mst.adicionaAresta('a11', 'C9', 'C10', 2)
        self.composto_1_mst.adicionaAresta('a20', 'C3', 'H6', 2)
        self.composto_1_mst.adicionaAresta('a22', 'O1', 'C2', 2)
        self.composto_1_mst.adicionaAresta('a27', 'C8', 'C6', 2)
        self.composto_1_mst.adicionaAresta('a31', 'C5', 'C4', 2)
        self.composto_1_mst.adicionaAresta('a32', 'C8', 'O2', 2)
        self.composto_1_mst.adicionaAresta('a43', 'H9', 'N2', 2)
        self.composto_1_mst.adicionaAresta('a7', 'C3', 'N1', 2)
        self.composto_1_mst.adicionaAresta('a14', 'C11', 'C9', 3)
        self.composto_1_mst.adicionaAresta('a23', 'N1', 'C8', 3)
        self.composto_1_mst.adicionaAresta('a33', 'C6', 'H10', 3)
        self.composto_1_mst.adicionaAresta('a35', 'C4', 'O3', 3)
        self.composto_1_mst.adicionaAresta('a36', 'C6', 'N2', 3)
        self.composto_1_mst.adicionaAresta('a38', 'C4', 'O4', 3)
        self.composto_1_mst.adicionaAresta('a39', 'O4', 'H13', 3)
        self.composto_1_mst.adicionaAresta('a5', 'C12', 'H15', 3)
        self.composto_1_mst.adicionaAresta('a9', 'C13', 'H12', 3)
        self.composto_1_mst.adicionaAresta('a29', 'C6', 'C5', 4)
        self.composto_1_mst.adicionaAresta('a4', 'H7', 'C11', 4)
        self.composto_1_mst.adicionaAresta('a19', 'C7', 'C9', 7)
    ...
    def test_Minimum_Spanning_Tree(self):
        self.assertEqual(self.g_p.MST_prim(), self.g_p_mst)
        self.assertEqual(self.g_p.MST_kruskal(), self.g_p_mst)
        self.assertEqual(self.g_d1.MST_prim(), False)
        self.assertEqual(self.g_d1.MST_kruskal(), False)
        self.assertEqual(self.grafo_dir_10.MST_prim(), self.grafo_dir_10_mst)
        self.assertEqual(self.grafo_dir_10.MST_kruskal(), self.grafo_dir_10_mst)
        self.assertEqual(self.weird_graph.MST_prim(), self.weird_graph_mst)
        self.assertEqual(self.weird_graph.MST_kruskal(), self.weird_graph_mst)
        self.assertEqual(self.g_d2.MST_prim(), False)
        self.assertEqual(self.g_d2.MST_kruskal(), False)
        self.assertEqual(self.spire_graph.MST_prim(), self.spire_graph_mst)
        self.assertEqual(self.spire_graph.MST_kruskal(), self.spire_graph_mst)
        self.assertEqual(self.m1.MST_prim(), self.m1_mst)
        self.assertEqual(self.m1.MST_kruskal(), self.m1_mst)
        self.assertEqual(self.g_d3.MST_prim(), False)
        self.assertEqual(self.g_d3.MST_kruskal(), False)
        self.assertEqual(self.social_media.MST_prim(), self.social_media_mst)
        self.assertEqual(self.social_media.MST_kruskal(), self.social_media_mst)
        self.assertEqual(self.m2.MST_prim(), self.m2_mst)
        self.assertEqual(self.m2.MST_kruskal(), self.m2_mst)
        self.assertEqual(self.composto_1.MST_prim(), self.composto_1_mst)
        self.assertEqual(self.composto_1.MST_prim(), self.composto_1_mst)
        self.assertEqual(self.g_d5.MST_prim(), False)
        self.assertEqual(self.g_d5.MST_kruskal(), False)